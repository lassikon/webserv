...
private:
  ...
  void create(logLevel LogLvl, const char *LvlTitle, const char *LvlColor, std::ostream &consoleStream, int LineNbr,
              const char *SrcFile, Args &&...args) {
...
public:
  template <typename... Args>
  static void Log(logLevel LogLvl, const char *LvlTitle, const char *LvlColor, std::ostream &ConsoleStream, int LineNbr,
                  const char *SrcFile, Args &&...args) {
